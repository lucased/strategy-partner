...
description: Three Horizons portfolio planning for strategy roadmaps and initiative sequencing. Use when mapping initiatives to timeframes, balancing short-term and long-term investments, creating phased roadmaps, or allocating resources across time horizons. Based on McKinsey's Three Horizons framework.
---
...
gantt
    ...
    dateFormat YYYY-MM
    section H1
    [Initiative A] : 2024-01, 12M
    section H2
    [Initiative B] : 2024-06, 18M
    section H3
    [Initiative C] : 2024-01, 24M
```
